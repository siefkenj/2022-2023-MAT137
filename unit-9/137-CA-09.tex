		...
		\begin{columns}
			...
			\begin{column}{.32\textwidth}
				...
				\begin{enumerate}
					...
					\item ${\displaystyle \int_0^3 x \, f'(x) dx}$

					\item ${\displaystyle \int_0^1 f(3x) dx}$
				\end{enumerate}
			\end{column}
		\end{columns}
	\end{frame}
...
%		\begin{multicols}{2}
%			\begin{itemize}
%				\item ${\displaystyle \int_1^e \left( \ln x \right)^3 dx}$ \p \vv
%
%				\item ${\displaystyle \int_1^{e} \left( \ln x \right)^{10} dx}$
%			\end{itemize}
%		\end{multicols}
%		\p There is a more efficient approach. Call
%		\[
...
%
%		Let ${\displaystyle I_n = \int_0^{2\pi} \sin^n x \, dx}$.
%		\vspace{.3cm}
%
%		\begin{enumerate}
...
%				\vspace{.3cm}
%
%			\item Write an equation for ${\displaystyle I_n}$ in terms of ${\displaystyle I_{n-2}}$.
...
%				in terms of ${\displaystyle I_n}$ and ${\displaystyle I_{n-2}}$.
%				\vspace{.3cm}
%
...
%
%		\begin{enumerate}
%			\item Calculate ${\displaystyle \int \frac{1}{x^{2} + 1} \, dx }$ and ${\displaystyle \int \frac{x}{x^{2}+1} \, dx}$.
%				\vv
%
%				\emph{Hint:} These two are very short. \vv
%
%			\item Calculate ${\displaystyle \int \frac{2x+ 3}{x^{2} + 1} \, dx }$ \vv
%
%			\item Calculate ${\displaystyle \int \frac{x^{2} }{x^{2} + 1} \, dx }$ \vv
%
%			\item Calculate ${\displaystyle \int \frac{x}{x^{2} + x + 1 } \, dx }$ \vv
%
...
%			\item How could we compute an integral of the form
%				\[
%					\int \frac{\mbox{polynomial}}{x^{4}(x+1)^{3}(x+2)(x^{2}+1)(x^{2}+4)}\,d
%					x \; ?
%				\]
%		\end{enumerate}
%	\end{frame}
