...
\begin{document}
\begin{frame}
	\frametitle{MAT137 Lecture 65 ---  Power series }

	\vfill
	{\bf Before next class:}
		\begin{itemize} \normalsize
			\item {\bf Watch videos 14.3, 14.4 }
		\end{itemize}
\end{frame}
	...
	\begin{frame}[t]
		...
		\begin{enumerate}
			\begin{multicols}{2}
				\item ${\displaystyle \sum_{n=0}^{\infty} \frac{x^{n}}{n!}}$ \vv \item ${\displaystyle \sum_{n=1}^{\infty} \frac{(x-5)^{n}}{n^{2} \, 2^{2n+1}} }$
				\vv \item ${\displaystyle \sum_{n=1}^{\infty} \frac{n^{n}}{42^{n}} x^n }$
				\vv \p \item {(Hard!)} ${\displaystyle \sum_{n=0}^{\infty} \frac{(3n)!}{n!(2n)!} \, x^n }$
				\vv
			\end{multicols}
		\end{enumerate}
	\end{frame}
	...
	\begin{frame}[t]
		...
		You know that \quad
		${\displaystyle \frac{1}{1-x} = \sum_{n=0}^{\infty} x^n}$ \quad for $|x|<1$

		Manipulate it to write the following functions as power series centered at 0:
		\begin{enumerate}
			\begin{multicols}{2}
				\item ${\displaystyle g(x) = \frac{1}{1+x}}$ \vv \item ${\displaystyle A(x) = \frac{1}{2-x}}$
				\vv

				\emph{Hint:} Factor ${\displaystyle 1/2}$. \item
				${\displaystyle h(x) = \frac{1}{1-x^{2}}}$ \vv \item
				${\displaystyle F(x) = \ln (1 + x)}$ \vv
...
\end{frame}
	...
	\begin{frame}[t]
		...
		\begin{enumerate}
			\begin{multicols}{2}
				\item ${\displaystyle f(x) = e^{-x}}$ \vvv \item ${\displaystyle f(x) = x^2 \cos x}$
				\vvv \item ${\displaystyle f(x) = \frac{1}{1+x}}$ \vvv \item ${\displaystyle f(x) = \frac{1}{1-x^{2}}}$
				\vvv \item ${\displaystyle f(x) = \frac{x}{3+2x}}$ \vvv \item ${\displaystyle f(x) = \sin \left(2 x^3 \right) }$
				\vvv \item ${\displaystyle f(x) = \frac{e^{x} + e^{-x}}{2}}$ \vvv \item ${\displaystyle f(x) = \ln \frac{1+x}{1-x} }$
				\vvv
			\end{multicols}
		\end{enumerate}
		\vvv
...
%
%		Let $f$ be a function defined at and near $a \in \R$. Let ${\displaystyle n \in \N}$.
%		\\ Let $P_{n}$ be the $n$-th Taylor polynomial for $f$ at $a$. \\ Which ones
%		of these are true?
%
%		\begin{enumerate}
...
%				\vfill
%
%			\item ${\displaystyle \lim_{x \to a} \left[ f(x) - P_n(x) \right] = 0}$
%				\vfill
%
...
%
%		Let $f$ be a function. Let $a \in \R$. Let $m \in \N$. \vvv
%		\begin{enumerate}
...
%
%		Let $f$ and $g$ be two functions with domain $\R$. Let $n \in \N$. \vvv
%
%		\begin{enumerate}
...
%		${\displaystyle F(x) = \sin x + \cos x}$ \; near 0? \vvv
%		\begin{enumerate}
%			\item ${\displaystyle f(x) = 1 + x - \frac{x^{2}}{2} }$ \vvv
%
%			\item ${\displaystyle g(x) = e^x -x^2 }$ \vvv
%
...
%		${\displaystyle F(x) = \begin{cases}e^{-1/x}&\mbox{ if }x >0, \\ 0&\mbox{ if }x \leq 0.\end{cases}}$
%
%		\begin{enumerate}
%			\item Prove that, for every $n \in \N$, ${\displaystyle \lim_{t \to \infty} t^n e^{-t} =0}$.
%
%			\item Prove that, for every $n \in \N$, ${\displaystyle \lim_{x \to 0^+} \frac{e^{-1/x}}{x^{n}}=0}$.
%
...
%			\item Calculate ${\displaystyle F''(0)}$ from the definition.
%
%			\item Prove that for every $n \in \N$, ${\displaystyle F^{(n)}(0) = 0}$.
%
...
%				Maclaurin series? What if $f$ is even? \vvv
%
%				\emph{Hint:} Think of $\sin$ and $\cos$. \vvv
%
%			\item Prove it. \vvv
%
%				\emph{Hints:}
...
%
%		Let ${\displaystyle f(x) = e^{x} \ln(1+x)}$ \vvv
%
%		\begin{enumerate}
%			\item Write the 4-th Taylor polynomial for $f$ at $a=0$. \vvv
%
%				{\setsize{11} \emph{Hint:} Write the first few terms of the Maclaurin series for each factor and multiply them. }
%				\vv
%
%			\item What is ${\displaystyle f^{(4)}(0)}$? \vv
%
%				\p
%
...
%			\begin{multicols}{2}
%				\item ${\displaystyle \sum_{n=1}^{\infty} \frac{n}{3^{n}}}$ \vv \item ${\displaystyle \sum_{n=1}^{\infty} \frac{n^{2}}{3^{n}}}$
%				\vv \item ${\displaystyle \sum_{n=0}^{\infty} \frac{x^{n+2}}{(n+1)(n+2)} }$
%				\vvv \item ${\displaystyle \sum_{n=0}^{\infty} \frac{x^{n}}{(n+2)n!}}$ \vvv
%				\item ${\displaystyle \sum_{n=0}^{\infty}(-1)^n \frac{(n+1)}{(2n)!} \, 2^n }$
%				\vvv \item ${\displaystyle \sum_{n=0}^{\infty} \frac{(-1)^{n}}{(2n+1)3^{n}}}$
%				\vvv
%			\end{multicols}
%		\end{enumerate}
%		\vv
